...
> </summary>
>
>> **Python ver** (1/4) <kbd>Single Select</kbd><br>
...
> - [ ] 4\. _Type something._
>
>> **Test libs** (2/4) <kbd>Multi Select</kbd><br>
...
>
>> **Error style** (3/4) <kbd>Single Select</kbd><br>
>> How should errors be surfaced to the caller?
...
>   - > This is a random note I wrote (it rhymes!)
>
>> **Scope** (4/4) <kbd>Multi Select</kbd><br>
...
> <details><summary>
>
>> 1. Select some numbers (testing order) — first batch:
>>    - Four, Two, Three, I will select first the extra option, then four, two, three. Yes yes.
>> 2. Pick a logging approach:
>>    - No logging
>>      ```text
>>      # nothing emitted here
>>      ```
>> 3. Pick a logging approach (one option has no preview):
>>    - No logging
>
> (click to expand)
>
> </summary>
>
>> **Numbers 1-4** (1/3) <kbd>Multi Select</kbd><br>
...
>
>> **Logging** (2/3) <kbd>Single Select</kbd><br>
>> Pick a logging approach:
> - [ ] 1\. Structured JSON
...
>
>> **Logging** (3/3) <kbd>Single Select</kbd><br>
